...
comercial y académico en Haskell. Se instala corriendo:
...
Este comando es válido para MacOS, Linux y Windows con WSL ó gitbash. Si no
estas usando alguno de esos sistemas podés leer las instrucciones de
[la página oficial](https://www.haskell.org/ghcup/).
